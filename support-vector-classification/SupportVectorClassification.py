...
def make_numerical_predictor_params_big(my_args):
    ...
    if my_args.use_polynomial_features:
        params["features__numerical__polynomial-features__degree"] = [ 3 ]
...
def make_decision_tree_params_grid_big(my_args):
    ...
    tree_params = {
        ...
        "model__min_samples_split": [ 0.01, 0.02, 0.03, 0.04, 0.06, 0.08, 0.16, 0.32, 0.64 ],
        "model__min_samples_leaf":  [ 1, 2, 3, 4, 5, 6 ],
        "model__max_features":  [ "sqrt", None ],
        "model__max_leaf_nodes": [ None ],
        "model__min_impurity_decrease": [ 0.0, 0.01, 0.02, 0.04, 0.08, 0.1],
    }
    params.update(tree_params)
    return params
